...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                URL url = new URL("https://glacial-bastion-6427.herokuapp.com/authenticate");
...
//            });
    ...
    /**
     * Represents an asynchronous registration task used to registration
     * the user.
     */
    public class UserRegisterTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                URL url = new URL("https://glacial-bastion-6427.herokuapp.com/create_user");
                HttpsURLConnection connection = (HttpsURLConnection)url.openConnection();

                String urlParameters = "name="+mName.replace(" ", "")+"&email="+mEmail+"&password="+mPassword;
                connection.setRequestMethod("POST");
